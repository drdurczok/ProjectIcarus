...
int main( int argc, const char** argv)
{
  ...
  option[1] = "Display Rectified Image";
  option[2] = "Create Disparity Map";
  option[3] = "Start Finger Capture";
  option[4] = "Exit";
  ...
  while(loop == true){
    ...
    switch(choice){
      ...
      case 1: calibration(1); break;
      case 2: disparity(); break;
