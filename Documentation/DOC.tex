...
A non-invasive and non-contact method is with vision systems. Free to the public libraries such as OpenCV paired with a stereo camera system allow for such a system to take place. A dual camera system adds depth mapping, reducing errors that can come from color based methods.
