...
\captionof{figure}{Dual Camera Disparity Map}   	
\end{center}
...
\begin{figure}[!hb]
	...
	\end{minipage}
	\captionof{figure}{Kinect Disparity Map}
\end{figure}
...
Besides a direct PC connection through USB which is usually used for debugging, we may also connect wirelessly through a Bluetooth connection. For this we need an additional module for the Arduino. Arduino allows us to have multiple serial connections with different speeds, so the communication with a bluetooth device HC-6 is done through universal asynchronous receiver-transmitter (UART) on 2 pins: rx and tx (receiver and transmitter). This may be seen below.

\begin{figure}[!hb]
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=\textwidth]{IMG/BT.jpeg}
		\captionof{figure}{Bluetooth Module Wiring}	   	
	\end{minipage}
    \hfill
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=0.8\textwidth]{IMG/BT_02.jpeg}
		\captionof{figure}{Bluetooth Module Code}   	
	\end{minipage}
\end{figure}
...
In order to assure our model is lightweight and has similar characteristics to the human hand, we needed to use compact, light but powerful motors. As motors can be rather expensive, we also needed to factor in price. We decided to go for SG92R as it fulfills enough requirements for the prototype and it is the best in its price range. Having 2.5kg*cm torque and 180deg movement range it is sufficient for demonstration of mechanics. Simulations in Solidworks confirm the geometry allows for velocities about half that of the real human hand. Below are two plots, one graphed by our hand, the other measurements taken from a human hand. We may see the velocity curve is similar, therefore our mechanics will allow for realistic movement. The peek speed was 414 mm/sec at about 45 degree angle in our situation.

\begin{figure}[!hb]
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=\textwidth]{IMG/mh01.png}
		\captionof{figure}{Velocity Plot of Simulated Kinematics}	   	
	\end{minipage}
    \hfill
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=0.8\textwidth]{IMG/mh02.png}
		\captionof{figure}{Velocity Plot of Human Hand}   	
	\end{minipage}
\end{figure}

The inbuilt simulation software allows us to animate the assembly and check its range of motion. We also were able to obtain accelerations and displacements of each joint required to check if the kinematic model was correct. 

\begin{figure}[!hb]
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=\textwidth]{IMG/mh03.png}
		\captionof{figure}{Acceleration Plot of Simulated Kinematics}	   	
	\end{minipage}
    \hfill
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=0.9\textwidth]{IMG/mh04.png}
		\captionof{figure}{Displacement Plot of Human Hand}   	
	\end{minipage}
\end{figure}
...
\begin{figure}[!hb]
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=0.92\textwidth]{IMG/mh08.png}
	\end{minipage}
    \hfill
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=\textwidth]{IMG/mh09.png}
	\end{minipage}
\end{figure}


FEM analysis performed allowed us to find the maximum force a single finger can output. It is about 8.23N so when the filament Fiberflex 40D that will be covering the fingertips to increase the grip strength  we can grab objects in range of 100-400grams, depending on the material that it is from. See table below for multiplicands that set the output force. 


\begin{center}
\includegraphics[width=0.4\textwidth]{IMG/mh05.png}
\includegraphics[width=0.6\textwidth]{IMG/mh06.png}
\end{center}
...
The below bills of materials includes all the materials used to build our working prototype. The prices provided are accessible market prices, and many of the elements where already owned or found at a lower price. The Kinect was kindly donated by Andrew Popiel from Lazy Solutions.

\begin{center}
\includegraphics[width=\textwidth]{IMG/BOM.png}
\end{center}

\section{Future Development}
Based on the entire design process above, we may start putting together the concept for the final product. With properly working mechanics, we may continue by increasing the number of fingers. With the prototyping phase almost complete, we may also begin constructing a version with other materials. A concept was created in blender software to display the possibilities of such a hand.

\begin{figure}[!hb]
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=\textwidth]{Render/MechHand9.png}
	\end{minipage}
    \hfill
    \begin{minipage}[b]{0.49\textwidth}
    	\centering
		\includegraphics[width=\textwidth]{Render/MechHand5.png}
	\end{minipage}
\end{figure}
...
\begin{thebibliography}{1}
   ...
   Pages 599-618 Retrieved form {\url{https://www.rehab.research.va.gov/jour/2013/505/page599.html}}
	...
	\bibitem{ARDSerial} Arduino Serial Connection Retrieved from {\url{https://www.arduino.cc/en/Reference/SoftwareSerial}}
	\bibitem{MECHSTAT} Human Hand Kinematics Analysis Retrieved from {\url{
https://waset.org/publications/10000325/measurement-and-analysis-of-human-hand-kinematics}}
